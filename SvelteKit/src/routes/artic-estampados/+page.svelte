...
<Background>
	...
	<main class="flex min-h-screen items-center justify-center gap-4 rounded-full">
		<div class={'rounded-md bg-orange-400 p-3 shadow-sm shadow-black'}>
			...
			<h1 class="w-full max-w-sm bg-orange-400 text-sm">
				| Son mas rentables que los disipadores comunes debido a que estas hechos de cobre, lo que
				absorbe mucho mejor el calor.
			</h1>
		</div>
